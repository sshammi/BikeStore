...
import { useGetPopularBikesQuery } from '@/redux/features/auth/authApi';
import { Skeleton } from '@/components/ui/skeleton';

const PopularBike = () => {
  const navigate = useNavigate();
  const { data: trendingResponse, isLoading } = useGetPopularBikesQuery({});
  ...
  return (
    <div className="p-6 mx-[10%]">
      <h2 className="text-3xl font-bold mb-8 mt-20 text-center">Popular Bikes</h2>
