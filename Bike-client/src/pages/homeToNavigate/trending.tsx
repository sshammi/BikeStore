...
import { useGetTrendingBikesQuery } from '@/redux/features/auth/authApi';
import { Skeleton } from '@/components/ui/skeleton';

const TrendingBike = () => {
  const navigate = useNavigate();
  const { data: trendingResponse, isLoading } = useGetTrendingBikesQuery({});
  ...
  return (
    <div className="p-6 mx-[10%]">
      <h2 className="text-3xl font-bold mb-8 mt-20 text-center">Trending Bikes</h2>
