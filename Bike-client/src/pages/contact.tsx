...
const ContactPage = () => {
  ...
  <div className="p-6 rounded-lg w-full max-w-xl mt-6 ">
      <h2 className="text-2xl font-semibold mb-10 text-gray-800 text-center mt-10">
        Contact Information
      </h2>
      <div className="flex gap-4">
        {/* Call Now Button */}
        <button className="flex items-center justify-center px-12 py-4 w-full bg-blue-100 text-gray-700 hover:bg-blue-400 rounded-xl">
        ...
        {/* Email Us Button */}
        <button className="flex items-center justify-center px-12 py-4 w-full bg-green-100 text-gray-700 rounded-xl hover:bg-green-400">
